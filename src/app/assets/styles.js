...
export const NAV_BAR_BACKGROUND_COLOR = PRIMARY_COLOR;
 ...
 * Back Button styles
 */
export const BACK_BUTTON_BACKGROUND_COLOR = PRIMARY_COLOR;
export const BACK_BUTTON_ICON_COLOR = PRIMARY_TEXT_COLOR;

/**
 * SearchBar styles
 */
export const SEARCH_BAR_HEIGHT = 50;
export const FONT_SEARCH_BAR_COLOR = PRIMARY_TEXT_COLOR;
export const FONT_SEARCH_BAR_SIZE = 20;
export const ICON_SEARCH_BAR_COLOR = SECONDARY_OF_COLOR;
export const ICON_SEARCH_BAR_SIZE = 24;

/** 
 * Text styles
 */
export const FONT_HEADER_COLOR = PRIMARY_TEXT_COLOR;
export const FONT_HEADER_SECONDARY_COLOR = TERTIARY_COLOR;
export const FONT_HEADER_SIZE = 34;
export const FONT_BODY_COLOR = PRIMARY_TEXT_COLOR;
export const FONT_BODY_COLOR_UNSELECTED = SECONDARY_OF_COLOR;
export const FONT_LINK_COLOR = SECONDARY_COLOR;
...
export const FONT_ERROR_COLOR = "red";
export const FONT_ERROR_SIZE = 16;
...
export const LOADING_CIRCLE_BACKGROUND_COLOR = PRIMARY_BACKGROUND_COLOR;
...
export const ICON_PROFILE_COLOR_FADED = 'rgba(0, 0, 0, 0.5);';
export const ICON_PROFILE_SIZE = 90;
 ...
 * Info COVID19 card
 */
export const COVID_19_FONT_HEADER_SIZE = 30;
export const COVID_19_FONT_HEADER_COLOR = PRIMARY_TEXT_COLOR;
export const COVID_19_FONT_BODY_SIZE = 14;
export const COVID_19_FONT_BODY_COLOR = "#6C6C6C";
export const COVID_19_FONT_BODY_DATE_COLOR = TERTIARY_COLOR;
export const COVID_19_FONT_BOTTOM_MARGIN = 2;
export const COVID_19_BORDER_COLOR = SECONDARY_OF_COLOR;
...
export const BORDER_COLOR_1 = SECONDARY_COLOR;
export const BORDER_COLOR_2 = SECONDARY_OF_COLOR;
export const BACKGROUND_COLOR = PRIMARY_BACKGROUND_COLOR;
export const HEADER_FILLER_HEIGHT = 76;

export const CARD_BACKGROUND_COLOR = '#2a2e39';


export const colorBackground = '#171717';
export const colorNavigationBar = '#131313';

//https://medium.com/@Krizzu/how-to-change-background-color-of-rootview-in-react-native-3279417c34bb
